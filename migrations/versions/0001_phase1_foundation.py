...
def downgrade() -> None:
    ...
    op.execute("DROP TABLE IF EXISTS organization_import_issue, organization_import, audit_record, outbox_event, organization_membership, person, organization_unit_closure, organization_unit, organization, tenant CASCADE")
